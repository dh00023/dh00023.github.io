...
![](http://btechsmartclass.com/DS/images/Graph%20Adjacency%20Matrix%201.jpg)
...
`std::vector()`를 이용하여 간단하게 구현할 수 있다. ( *[vector 알아보기](https://dh00023.github.io/algorithm/ds/2018/05/26/cpp-vector/)* )이때 인접행렬로 구현하는 것보다 공간을 적게 사용한다. 각 정점에서 연결되는 리스트의 순서는 중요하지 않다.
